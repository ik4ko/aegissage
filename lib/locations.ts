...
export const locationLandings: LocationLanding[] = [
  {
    ...
    localFocus: [
      ...
      'Verification needed: add the advisor’s verified county-by-county plan availability examples for the New Jersey counties served before publishing specific plan or carrier references.',
    ],
    enrollment:
    ...
    verificationNote: 'Verification needed: confirm the counties and local plan-market facts this page should name for the current contract year.',
  ...
  },
  {
    ...
    localFocus: [
      ...
      'Verification needed: add verified borough-level availability and any New York-specific Medigap protections after the advisor confirms the current-year details.',
    ],
    enrollment:
    ...
    verificationNote: 'Verification needed: confirm the boroughs, counties, and current-year New York rules that should be named on this page.',
  ...
  },
  {
    ...
    verificationNote: 'Verification needed: confirm the exact Philadelphia-area counties and local market details that should be referenced for this contract year.',
