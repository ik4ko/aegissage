 ...
 *  The plan and organization counts come from lib/site.ts (`compliance`) and
 *  must be re-verified at the start of every contract year, along with
 *  `compliance.currentAsOf`.
 *
 ...
 *   2. The plan/organization counts match the advisor's actual contracts.
      ...
      <div className="container max-w-3xl py-10 sm:py-12">
        ...
        <div className="mt-5 space-y-4 text-sm leading-relaxed text-white/85">
          ...
          <p>
            ...
            {compliance.organizationCount} organizations which offer{' '}
            {compliance.planCount} products in your area. Please contact{' '}
            <a
